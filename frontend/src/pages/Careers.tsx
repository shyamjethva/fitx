        ...
        <ScrollReveal type="slide-up">
          <div className="text-center mb-20">
            ...
            <h1 className="text-5xl md:text-8xl font-black text-white tracking-tighter uppercase leading-none mb-6">
              BUILD FUTURE <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FFA040] to-[#00B0FF]">ATHLETICS</span>
            </h1>
          ...
          {[
            ...
            <ScrollReveal key={perk.title} type="scale">
              <div className="p-8 rounded-[32px] border border-white/5 bg-white/[0.02] backdrop-blur-3xl space-y-4">
                <span className="text-xs font-black text-[#FFA040] tracking-widest uppercase">PERK 0{i + 1}</span>
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            {JOBS.map((job) => (
              <ScrollReveal key={job.id} type="slide-up">
                <div className="group p-8 rounded-[40px] border border-white/5 bg-white/[0.01] hover:bg-white/[0.03] hover:border-[#FFA040]/20 transition-all duration-500 space-y-6">
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                      <span className="text-[10px] font-black text-[#FFA040] tracking-widest uppercase bg-[#FFA040]/10 px-3 py-1 rounded-full">{job.dept}</span>
                      <h3 className="text-2xl font-bold text-white uppercase mt-3 group-hover:text-[#FFA040] transition-colors">{job.title}</h3>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap items-center gap-6 pt-4 border-t border-white/5 text-[11px] text-white/40 uppercase tracking-widest font-bold">
                    ...
                    <div className="flex items-center gap-2">
                      <DollarSign className="w-4 h-4 text-[#FFA040]" />
              ...
              <div className="sticky top-28 p-8 md:p-10 rounded-[48px] border border-white/10 bg-white/[0.02] backdrop-blur-3xl shadow-2xl space-y-8">
                ...
                {submitted ? (
                  <motion.div 
                    ...
                    className="p-6 rounded-2xl bg-[#FFA040]/10 border border-[#FFA040]/20 flex flex-col items-center text-center gap-4"
                  >
                    <CheckCircle className="w-12 h-12 text-[#FFA040]" />
                    <div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <input 
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-xl p-4 text-white text-sm outline-none focus:border-[#FFA040]/50 transition-colors"
                    ...
                    <div className="space-y-2">
                      ...
                      <select 
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-xl p-4 text-white text-sm outline-none focus:border-[#FFA040]/50 transition-colors uppercase tracking-wider"
                      >
                        {JOBS.map(job => (
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea 
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-xl p-4 text-white text-sm outline-none focus:border-[#FFA040]/50 transition-colors resize-none"
                    ...
                    <button 
                      type="submit"
                      className="w-full bg-gradient-to-r from-[#FFA040] to-[#00B0FF] text-slate-950 font-black text-xs tracking-[0.2em] uppercase py-5 rounded-2xl hover:brightness-110 active:scale-[0.99] transition-all flex items-center justify-center gap-2"
                    >
