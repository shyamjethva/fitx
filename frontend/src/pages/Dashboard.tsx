              ...
              {isEditing ? (
                <>
                  <button
                    ...
                    className="flex-1 bg-white/5 hover:bg-white/10 text-white font-black py-4 rounded-2xl transition-all text-xs uppercase tracking-widest border border-white/5 active:scale-95"
                  >
                    DISCARD CHANGES
                  </button>
                  <button
                    type="submit"
                    disabled={isSaving}
                    className="flex-1 bg-[#00E5FF] hover:bg-white text-black font-black py-4 rounded-2xl transition-all text-xs uppercase tracking-widest shadow-[0_10px_20px_rgba(0,229,255,0.25)] active:scale-95 disabled:opacity-50"
                  >
                ...
                <>
                  <button
                    ...
                    className="flex-1 bg-[#00E5FF] hover:bg-white text-black font-black py-4 rounded-2xl transition-all text-xs uppercase tracking-widest shadow-[0_10px_20px_rgba(0,229,255,0.25)] active:scale-95 text-center"
                  >
