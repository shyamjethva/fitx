...
export default function PrivacyPolicy() {
  const sections = [
    {
      icon: <Eye className="w-5 h-5 text-[#FFA040]" />,
    ...
    {
      icon: <Lock className="w-5 h-5 text-[#FFA040]" />,
    ...
    {
      icon: <ShieldCheck className="w-5 h-5 text-[#FFA040]" />,
    ...
    {
      icon: <FileText className="w-5 h-5 text-[#FFA040]" />,
  ...
  return (
    <div className="relative w-full min-h-screen pt-32 pb-24 bg-black overflow-hidden selection:bg-[#FFA040]/30 text-white/80">
        ...
        <ScrollReveal type="slide-up">
          <div className="text-center mb-20">
            ...
            <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter uppercase leading-none mb-6">
              PRIVACY <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FFA040] to-[#00B0FF]">POLICY</span>
            </h1>
        ...
        <ScrollReveal type="scale">
          <div className="p-8 md:p-14 rounded-[48px] border border-white/5 bg-white/[0.01] backdrop-blur-3xl shadow-2xl space-y-12">
            ...
            <div className="pt-8 border-t border-white/5">
              ...
              <div className="bg-[#FFA040]/5 border border-[#FFA040]/10 p-6 rounded-2xl">
                <p className="text-[10px] font-bold tracking-widest text-[#FFA040] uppercase">Direct Inquiries Address</p>
