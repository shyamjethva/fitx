...
const stats = [
  { label: "Active Members", value: "15k+", icon: <Users className="w-6 h-6 text-[#FFA040]" /> },
  { label: "Elite Coaches", value: "120+", icon: <Award className="w-6 h-6 text-[#FFA040]" /> },
  { label: "Success Stories", value: "50k+", icon: <Trophy className="w-6 h-6 text-[#FFA040]" /> },
  { label: "Global Centers", value: "85+", icon: <Target className="w-6 h-6 text-[#FFA040]" /> }
];
...
export default function About() {
  ...
  return (
    <div className="flex flex-col w-full premium-bg min-h-screen pt-32 pb-20 overflow-x-hidden text-white font-sans relative selection:bg-[#FFA040]/20">
      <BackgroundGlows />
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {stats.map((stat, idx) => (
            <ScrollReveal key={stat.label} type="scale" delay={idx * 100}>
              <div className="p-8 md:p-10 rounded-[32px] border border-white/5 bg-white/[0.01] hover:bg-white/[0.03] hover:border-[#FFA040]/20 flex flex-col items-center text-center group transition-all duration-500 shadow-2xl backdrop-blur-3xl">
                <div className="mb-6 p-4 bg-white/5 border border-white/10 rounded-2xl text-[#FFA040] group-hover:scale-110 group-hover:bg-[#FFA040]/10 group-hover:border-[#FFA040]/25 transition-all duration-500">
                  {stat.icon}
                </div>
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="lg:w-1/2 w-full space-y-8">
            <ScrollReveal type="slide-up">
              ...
              <div className="pt-6">
                <button className="group flex items-center gap-4 text-[#FFA040] font-black text-sm tracking-widest uppercase">
                  <span>Explore our journey</span>
                  <div className="w-12 h-12 rounded-full border border-[#FFA040]/30 flex items-center justify-center group-hover:bg-[#FFA040] group-hover:text-black transition-all">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {values.map((val) => (
            <ScrollReveal key={val.title} type="scale">
              <div className="flex flex-col items-center text-center p-10 rounded-[40px] bg-white/[0.01] border border-white/5 hover:border-[#FFA040]/20 hover:bg-white/[0.03] transition-all duration-500 group shadow-2xl">
                <div className="mb-8 w-20 h-20 rounded-3xl bg-white/5 flex items-center justify-center border border-white/10 group-hover:bg-[#FFA040] group-hover:text-slate-950 transition-all duration-700">
                  {val.icon}
                </div>
