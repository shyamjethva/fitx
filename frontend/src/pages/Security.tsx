...
export default function Security() {
  ...
  const protocols = [
    {
      icon: <EyeOff className="w-6 h-6 text-[#FFA040]" />,
    ...
    {
      icon: <Key className="w-6 h-6 text-[#FFA040]" />,
    ...
    {
      icon: <Server className="w-6 h-6 text-[#FFA040]" />,
    ...
    {
      icon: <Terminal className="w-6 h-6 text-[#FFA040]" />,
        ...
        <ScrollReveal type="slide-up">
          <div className="text-center mb-24">
            ...
            <h1 className="text-5xl md:text-8xl font-black text-white tracking-tighter uppercase leading-none mb-6">
              MILITARY GRADE <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FFA040] to-[#00B0FF]">SAFEGUARDS</span>
            </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-24">
          {protocols.map((p, i) => (
            <ScrollReveal key={p.title} type="slide-up">
              <div className="p-10 rounded-[40px] border border-white/5 bg-white/[0.01] hover:border-[#FFA040]/15 hover:bg-white/[0.03] transition-all duration-500 flex flex-col md:flex-row gap-6">
          ...
          <div className="lg:col-span-6 space-y-6">
            <ScrollReveal type="slide-up">
              ...
              <h2 className="text-3xl md:text-5xl font-black text-white uppercase tracking-tighter leading-none mt-4">
                Found a <span className="text-[#FFA040]">vulnerability</span> in our ecosystem?
              </h2>
              ...
              <div className="flex gap-8 pt-4 text-xs font-bold uppercase tracking-wider text-white/40">
                <div>
                  <div className="text-white font-black text-xl text-[#FFA040]">24 hrs</div>
                  <div className="mt-1">Response Guarantee</div>
                </div>
                <div className="w-[1px] bg-white/10" />
                <div>
                  <div className="text-white font-black text-xl text-[#FFA040]">Bounty</div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea 
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-xl p-4 text-white text-sm outline-none focus:border-[#FFA040]/50 transition-colors resize-none font-mono text-xs"
