            ...
            <section className="py-10 bg-transparent relative overflow-hidden px-4 md:px-20">
               <div className="max-w-7xl mx-auto flex flex-col items-center">
                  ...
                  {(() => {
                     ...
                     const gridColsClass = activePlans.length === 1 ? 'lg:grid-cols-1' : activePlans.length === 2 ? 'lg:grid-cols-2' : 'lg:grid-cols-3';
                     
                     return (
                        <div className={`grid grid-cols-1 sm:grid-cols-2 ${gridColsClass} gap-8 w-full mt-10 justify-center max-w-5xl mx-auto`}>
