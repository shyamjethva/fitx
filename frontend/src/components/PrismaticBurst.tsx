...
const PrismaticBurst: React.FC<PrismaticBurstProps> = ({
  ...
  useEffect(() => {
    ...
    gl.canvas.style.mixBlendMode = mixBlendMode && (mixBlendMode as any) !== 'none' ? mixBlendMode : '';
    ...
    let ro: ResizeObserver = new ResizeObserver(resize);
  ...
  useEffect(() => {
    ...
    if (canvas) {
      canvas.style.mixBlendMode = mixBlendMode && (mixBlendMode as any) !== 'none' ? mixBlendMode : '';
    }
  }, [mixBlendMode]);
