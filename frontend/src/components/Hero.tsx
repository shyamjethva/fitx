    ...
    <section id="hero" className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-transparent">
      ...
      <div className="relative z-20 text-center px-6 max-w-7xl pt-24 md:pt-0">
        ...
        >
          ...
          {/* Title */}
          <h1 className="font-sans text-[15vw] sm:text-[100px] md:text-[140px] lg:text-[180px] leading-[1] tracking-tight font-black select-none bg-gradient-to-r from-white via-white to-white/70 bg-clip-text text-transparent drop-shadow-2xl uppercase">
            {title}
          </h1>
