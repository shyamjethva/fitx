...
export const Footer = () => {
   ...
   return (
      <footer className="bg-black text-white py-16 px-6 md:px-24 border-t border-white/5">
         <div className="max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 lg:gap-8">
            ...
            <div className="col-span-1 lg:col-span-2 flex flex-col gap-4 lg:gap-6">
               <Link to="/fitness" className="font-sans text-white/50 hover:text-white transition-colors text-sm font-bold uppercase">FitX for business</Link>
               <Link to="/fitness/elite" className="font-sans text-white/50 hover:text-white transition-colors text-sm font-bold uppercase">FitX ELITE</Link>
               <Link to="/fitness/pro" className="font-sans text-white/50 hover:text-white transition-colors text-sm font-bold uppercase">FitX PRO</Link>
               <Link to="/fitness/home" className="font-sans text-white/50 hover:text-white transition-colors text-sm font-bold uppercase">FitX HOME</Link>
               <Link to="/fitness/transform" className="font-sans text-white/50 hover:text-white transition-colors text-sm font-bold uppercase">FitX TRANSFORM</Link>
            </div>

            {/* Links Column 2 */}
            <div className="col-span-1 lg:col-span-2 flex flex-col gap-4 lg:gap-6">
               <Link to="/fitness" className="font-sans text-white/50 hover:text-white transition-colors text-sm font-bold uppercase">Partner.fit</Link>
               <Link to="/blogs" className="font-sans text-white/50 hover:text-white transition-colors text-sm font-bold uppercase">Blogs</Link>
               <Link to="/careers" className="font-sans text-white/50 hover:text-white transition-colors text-sm font-bold uppercase">Careers</Link>
               <Link to="/security" className="font-sans text-white/50 hover:text-white transition-colors text-sm font-bold uppercase">Security</Link>
            </div>

            {/* Links Column 3 */}
            <div className="col-span-1 lg:col-span-2 flex flex-col gap-4 lg:gap-6">
               <Link to="/help-center" className="font-sans text-white/50 hover:text-white transition-colors text-sm font-bold uppercase">Help Center</Link>
               <Link to="/contact" className="font-sans text-white/50 hover:text-white transition-colors text-sm font-bold uppercase">Contact Us</Link>
               <Link to="/privacy-policy" className="font-sans text-white/50 hover:text-white transition-colors text-sm font-bold uppercase">Privacy Policy</Link>
               <Link to="/fitness" className="font-sans text-white/50 hover:text-white transition-colors text-sm font-bold uppercase">FitX BMI Calculator</Link>
               <Link to="/about" className="font-sans text-white/50 hover:text-white transition-colors text-sm font-bold uppercase">Terms & Conditions</Link>
            </div>
            ...
            <div className="col-span-1 lg:col-span-2 flex flex-col items-start lg:items-end gap-6">
               {globalSettings?.image && (
                  <div className="mb-2">
                     <p className="text-xs font-black uppercase text-white/60 mb-2">Scan to Join</p>
